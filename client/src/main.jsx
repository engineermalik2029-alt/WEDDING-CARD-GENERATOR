  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#08070d] text-amber-50">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-amber-200/20 bg-white/10 px-4 py-2 text-sm font-semibold text-amber-100 backdrop-blur">
              <Sparkles className="h-4 w-4 text-amber-300" /> Free forever premium wedding invitations
            </div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-amber-50/70">
              Select a luxury design direction, add your wedding details, upload a personal photo, and generate a polished share-ready invitation for free. Optional AI/cloud upgrades stay available for production.
            </p>
      ...
      <section id="create" className="relative mx-auto grid max-w-7xl gap-6 px-4 pb-16 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        <div className="space-y-6">
          ...
          <Panel title="2. Upload couple photo" subtitle="JPG, PNG, or WebP. Max 5MB with live preview.">
            <label className="flex cursor-pointer flex-col items-center justify-center rounded-3xl border border-dashed border-amber-100/25 bg-black/20 p-6 text-center transition hover:border-amber-300/70">
              ...
              <span className="mt-1 text-sm text-amber-50/60">Free mode stores it locally. Cloudinary is optional for production.</span>
        ...
        <div className="space-y-6">
          <Panel title="3. Wedding details" subtitle="The live preview updates instantly while the final card is generated by the free local engine.">
          ...
          <Panel title="4. Generate & share" subtitle="Free forever mode creates the invitation locally. OpenAI/Cloudinary/MongoDB are optional upgrades.">
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-semibold text-amber-50/55">Free local cards • Optional AI/cloud</p>
          </div>
        </div>
